...
namespace Nop.Services.Customers
{
    ...
    public partial class CustomerRegistrationService : ICustomerRegistrationService
    {
        ...
        public virtual async Task<CustomerRegistrationResult> RegisterCustomerAsync(CustomerRegistrationRequest request)
        {
            ...
            query.Criteria.AddCondition("emailaddress1", ConditionOperator.Equal, request.Email);
            ...
            {
                // Email exists
                result.AddError("Current customer is already registered in Crm");
                return result;
            }
            ...
            // Insert the new contact entity into Dynamics CRM
            Guid newContactId = _serviceClient.Create(newContact);
